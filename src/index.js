...
window.addEventListener('load', () => {
    ...
    const materialsTabsOptions = {
        ...
        interviewsTitle: document.getElementsByClassName('js-interviews-title')[0],
        ...
        interviewsButton: document.getElementsByClassName('js-interviews-button')[0],
        ...
        materialsInterviews: document.getElementsByClassName('js-materials-interviews-list')[0],
